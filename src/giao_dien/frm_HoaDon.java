...
public class frm_HoaDon extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tbl_chitiethoadon.setBackground(new java.awt.Color(0, 88, 124));
        tbl_chitiethoadon.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jButton1.setBackground(new java.awt.Color(0, 171, 253));
        jButton1.setForeground(new java.awt.Color(205, 241, 255));
        ...
        btn_xoachitiet.setBackground(new java.awt.Color(0, 171, 253));
        btn_xoachitiet.setForeground(new java.awt.Color(205, 241, 255));
        ...
        btn_themhoadon.setBackground(new java.awt.Color(0, 171, 253));
        btn_themhoadon.setForeground(new java.awt.Color(205, 241, 255));
        ...
        btn_themchitiet.setBackground(new java.awt.Color(0, 171, 253));
        btn_themchitiet.setForeground(new java.awt.Color(205, 241, 255));
        ...
        tbl_hoadon1.setBackground(new java.awt.Color(0, 88, 124));
        tbl_hoadon1.setForeground(new java.awt.Color(255, 255, 255));
        ...
        btn_xoahoadon.setBackground(new java.awt.Color(0, 171, 253));
        btn_xoahoadon.setForeground(new java.awt.Color(205, 241, 255));
        ...
        btn_xemchitiet.setBackground(new java.awt.Color(0, 171, 253));
        btn_xemchitiet.setForeground(new java.awt.Color(205, 241, 255));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jTabbedPane1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 484, Short.MAX_VALUE)
        );
    ...
    private void btn_xemchitietMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_xemchitietMouseClicked
        /*try {
            // TODO add your handling code here:
            List<TTHoaDon> lst_TTHoaDon = dao.dao_TTHoaDon.getTTHD(Integer.valueOf(txt_mahoadon1.getText()));
            DefaultTableModel tblModel = new DefaultTableModel();
            tblModel.addColumn("Mã sản phẩm");      
            tblModel.addColumn("Số lượng");   
